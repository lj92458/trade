package com.liujun.trade.controller;


import com.liujun.trade.bean.ChatMsg;
import com.liujun.trade.bean.ChatRoom;
import com.liujun.trade.bean.RoomContext;
...
public class UserChatController {
    private static Logger logger = LoggerFactory.getLogger(com.liujun.trade.controller.UserChatController.class);
    //每个聊天室缓存最大聊天信息条数，该值由SpringMVC的配置文件注入，超过该值将清理出缓存
    @Value("#{configProperties['chat.maxHistory']}")
...
*/
    ...
    public ChatRoom<ChatMsg> initChatRoom(@DestinationVariable String roomid,
        ...
        logger.info("-------" + nickName + "进入聊天室------" + roomid);
