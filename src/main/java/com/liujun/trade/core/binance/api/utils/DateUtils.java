package com.liujun.trade.core.binance.api.utils;
...
public class DateUtils {
    ...
    static {
        com.liujun.trade.core.binance.api.utils.DateUtils.SDF.setTimeZone(TimeZone.getTimeZone("UTC"));
    }
    ...
    public static String timeToString(Date time, final int style) {
        ...
        switch (style) {
            case 1: {
                timeStyle = com.liujun.trade.core.binance.api.utils.DateUtils.TIME_STYLE_S1;
                break;
            }
            case 2: {
                timeStyle = com.liujun.trade.core.binance.api.utils.DateUtils.TIME_STYLE_S2;
                break;
            }
            case 3: {
                timeStyle = com.liujun.trade.core.binance.api.utils.DateUtils.TIME_STYLE_S3;
                break;
            }
            case 4: {
                timeStyle = com.liujun.trade.core.binance.api.utils.DateUtils.TIME_STYLE_S4;
                break;
            }
            case 5: {
                timeStyle = com.liujun.trade.core.binance.api.utils.DateUtils.TIME_STYLE_S5;
                break;
            }
            case 6: {
                timeStyle = com.liujun.trade.core.binance.api.utils.DateUtils.TIME_STYLE_S6;
                break;
            }
            case 7: {
                timeStyle = com.liujun.trade.core.binance.api.utils.DateUtils.TIME_STYLE_S7;
                break;
            }
            case 8: {
                final SimpleDateFormat sdf = (SimpleDateFormat) com.liujun.trade.core.binance.api.utils.DateUtils.SDF.clone();
                return sdf.format(time);
            }
            case 9: {
                return com.liujun.trade.core.binance.api.utils.DateUtils.getEpochTime(time);
            }
            default: {
    ...
    /**
     * {@link com.liujun.trade.core.binance.api.utils.DateUtils#timeToString(Date, int)}
     *
     * @param time Date object, if time=null, returns null.
     */
    public static String timeToStringNull(final Date time, final int style) {
        return time == null ? null : com.liujun.trade.core.binance.api.utils.DateUtils.timeToString(time, style);
    }
    ...
    public static Date parseUTCTime(final String utcTime) throws ParseException {
        ...
        final SimpleDateFormat sdfi = (SimpleDateFormat) com.liujun.trade.core.binance.api.utils.DateUtils.SDF.clone();
