package com.liujun.trade.core.binance.api.client;

import com.liujun.trade.core.binance.api.config.APIConfiguration;
import com.liujun.trade.core.binance.api.constant.APIConstants;
import com.liujun.trade.core.binance.api.enums.ContentTypeEnum;
import com.liujun.trade.core.binance.api.enums.HttpHeadersEnum;
import com.liujun.trade.core.binance.api.enums.SECURITY_TYPE;
import com.liujun.trade.core.binance.api.exception.APIException;
import com.liujun.trade.core.binance.api.utils.DateUtils;
import com.liujun.trade.core.binance.api.utils.HmacSHA256Base64Utils;
import okhttp3.*;
import okio.Buffer;
...
public class APIHttpClient {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.liujun.trade.core.binance.api.client.APIHttpClient.class);
    ...
    private void printRequest(final Request newRequest, final String timestamp, Request oldRequest) {
        ...
        com.liujun.trade.core.binance.api.client.APIHttpClient.LOG.info(requestInfo.toString());
    }
}
