...
public class Trade_binance extends Trade {
    ...
    public int tradeOrder() throws Exception {
        ...
        for (; orderCount < userOrderList.size(); orderCount++) {
            ...
            param.setPrice(order.getPrice() + addPrice);// price
            param.setRecvWindow(recvWindow);// recvWindow

            AddOrderResultACK result = this.spotOrderAPIServive.addOrderACK(param);
            // 设置orderId
            UserOrder thisOrder = userOrderList.get(orderCount);
    ...
    public int queryOrderState() throws Exception {
        ...
        for (UserOrder o : userOrderList) {
            QueryOrderResult result = spotOrderAPIServive.queryOrder(coinPair, Long.parseLong(o.getOrderId()),
    ...
    public void cancelOrder() throws Exception {
        ...
        for (UserOrder o : userOrderList) {
            CancelOrderResult result = this.spotOrderAPIServive.cancelOrder(coinPair, Long.parseLong(o.getOrderId()),
