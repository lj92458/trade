...
import com.liujun.trade.core.binance.api.bean.ett.result.CursorPager;
import com.liujun.trade.core.binance.api.bean.futures.HttpResult;
...
public class APIClient {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.liujun.trade.core.binance.api.client.APIClient.class);
    ...
    private void printResponse(final Response response) {
        ...
        com.liujun.trade.core.binance.api.client.APIClient.LOG.info(responseInfo.toString());
    }
